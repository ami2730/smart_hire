const { PrismaClient, Role, JobStatus, ResumeProcessingStatus, ApplicationStatus, ScreeningRecommendation } = require('@prisma/client');
...
async function main() {
  ...
  const applicationsData = [
    // App 1: Alex Johnson -> Job 1 (Senior Full Stack & AI)
    {
    ...
    // App 2: Sara Tadesse -> Job 1 (Senior Full Stack & AI)
    {
    ...
    // App 3: Michael Chen -> Job 1 (Senior Full Stack & AI)
    {
    ...
    // App 4: Sara Tadesse -> Job 2 (Senior Backend Engineer)
    {
      candidateEmail: 'sara.tadesse@example.com',
      jobId: job2.id,
      status: ApplicationStatus.SHORTLISTED,
    ...
    // App 5: Bethlehem Assefa -> Job 3 (ML Platform & NLP)
    {
    ...
    // App 6: Dawit Haile -> Job 4 (DevOps & Cloud Infrastructure)
    {
      candidateEmail: 'dawit.haile@example.com',
      jobId: job4.id,
      status: ApplicationStatus.APPLIED,
    },
    // App 7: Hana Mekonnen -> Job 5 (Product Designer)
    {
    ...
    // App 8: Dawit Haile -> Job 1 (Senior Full Stack & AI)
    {
      candidateEmail: 'dawit.haile@example.com',
      jobId: job1.id,
      status: ApplicationStatus.SCREENED,
